...
function ExperienceCard() {
    return (
        <article
            className='section-wrapper flex flex-col lg:flex-row items-center justify-center text-center px-4 md:px-10 lg:px-20 pt-16'>
            ...
            >
                <Image className='layout-image bg-[#251857] max-h-72'
            ...
            <div className='layout-wrapper'>
                <h3 className='layout-subtitle text-left'>Full-Stack Developer</h3>
