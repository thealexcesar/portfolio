export const pt = {
    about: [
        "Sobre",
        "Um pouco Sobre Mim",
        "Sou um desenvolvedor web full-stack com 2 anos de experiência em",
        "Sou apaixonado por tecnologia e acredito que ela pode ser usada para melhorar a vida das pessoas. Estou sempre em busca de maneiras de utilizar minhas habilidades para criar projetos úteis e envolventes."
    ],
    content: [
        "Portfólio de Alex",
    ...
    experience: [
        ...
        "Set 2021 · 25 de ago de 2023 · 2 anos",
        "Blumenau/SC · Híbrido · período integral",
        "Visite o aplicativo Nucleus"
    ],
    hero: ['sobre', 'experiência', 'habilidades', 'experiência'],
    labels: [
